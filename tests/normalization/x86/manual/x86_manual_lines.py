...
X86_TEST_INPUTS = [
...

    {
        ...
        'x86_base': ['mov rax qword [ rip + 2433805 ]'],
...

    {
        ...
        'x86_base': ['mov edi 4440166 "No{sp}%s{sp}section{sp}present\\n\\n"'],
        'x86_innereye': ['mov edi {str}'],
        'x86_deepbindiff': ['mov {reg}4 "No{sp}%s{sp}section{sp}present\\n\\n"'],
        'x86_safe': ['mov edi {immval}'],
        'x86_deepsemantic': ['mov {reg}4 {str}'],
        'x86_hpc': ['mov edi {split_imm} 4440 166 "No{sp}%s{sp}section{sp}present\\n\\n"'],
...

    {
        ...
        'x86_base': ['push qword [ rip + 2433810 ]'],
        'x86_innereye': ['push [ rip + {immval} ]'],
...

    {
        ...
        'x86_base': ['jmp qword [ rip + 2433812 ]'],
...

    {
        ...
        'x86_base': ['cmp dword [ rip + 2437002 ] 0'],
...

    {
        ...
        'x86_base': ['mov rsi qword [ rip + 2434938 ]'],
...

    {
        ...
        'x86_base': ['test byte [ rax + rax + 6646400 ] 4'],
    ...
    {
        'input': '0x00404449: repne_scasb',
        'bad_assembly': False, 
        'x86_base_tokenizer': [
            (Tokens.INSTRUCTION_ADDRESS, '0x00404449:'), (Tokens.SPACING, ' '), 
            (Tokens.INSTRUCTION_PREFIX, 'repne'), (Tokens.OPCODE, 'scasb'),
            (Tokens.NEWLINE, '\n'),
        ],
    ...
    {  # Multiple prefixes in the correct order, along with a weird memory address, different immediates/registers, and COLON register address
        ...
        'bad_assembly': True, 
        'x86_base_tokenizer': [
            (Tokens.INSTRUCTION_PREFIX, 'lock'), (Tokens.INSTRUCTION_PREFIX, 'repne'), (Tokens.INSTRUCTION_PREFIX, 'rep'),
                (Tokens.INSTRUCTION_PREFIX, 'repe'), (Tokens.INSTRUCTION_PREFIX, 'lock'),
            (Tokens.OPCODE, 'add'),
            (Tokens.SPACING, '  '), (Tokens.MEMORY_SIZE, 'v2xmmword ptr'), (Tokens.SPACING, ' '), 
        ...
        'x86_base': ['lock repne rep repe lock add v2xmmword [ 3 + r14 * 11 + rip * 124 + mxcsr ] gs:rip'],  # Leaves gs: alone
        'x86_innereye': ['lock repne rep repe lock add [ {immval} + r14 * {immval} + rip * {immval} + mxcsr ] {seg}:rip'],
    ...
    {  # A real opcode with an underscore mixed in with instruction prefixes
        'input': 'lock_repne_vcmpneq_oqsd.rep,pt r15',
        'bad_assembly': True, 
        'x86_base_tokenizer': [
            (Tokens.INSTRUCTION_PREFIX, 'lock'), (Tokens.SPACING, ' '), (Tokens.INSTRUCTION_PREFIX, 'repne'), 
                (Tokens.SPACING, ' '),  (Tokens.INSTRUCTION_PREFIX, 'rep'), (Tokens.SPACING, ' '), 
                (Tokens.BRANCH_PREDICTION, 'pt'), (Tokens.SPACING, ' '),
            (Tokens.OPCODE, 'vcmpneq_oqsd'),
            (Tokens.SPACING, ' '), (Tokens.REGISTER, 'r15'),
            (Tokens.NEWLINE, '\n'),
        ],
        'x86_base': ['lock repne rep vcmpneq_oqsd r15'],
        'x86_innereye': ['lock repne rep vcmpneq_oqsd r15'],
    ...
    {  # Rose negative immediates insert minus signs properly (different depending on normalization)
        ...
        'x86_base_tokenizer': [
            (Tokens.OPCODE, 'add'), (Tokens.SPACING, ' '), 
            (Tokens.IMMEDIATE, '-3'), (Tokens.SPACING, ' '),
            (Tokens.OPEN_BRACKET, '['), (Tokens.REGISTER, 'rip'), (Tokens.SPACING, ' '), (Tokens.PLUS_SIGN, '+'),
    ...
    {  # Jump with branch prediction (not taken)
        ...
        'x86_base_tokenizer': [
            (Tokens.INSTRUCTION_PREFIX, 'lock'), (Tokens.SPACING, ' '), (Tokens.INSTRUCTION_PREFIX, 'repne'),
                (Tokens.SPACING, ' '), (Tokens.BRANCH_PREDICTION, 'pn'), (Tokens.SPACING, ' '), (Tokens.OPCODE, 'jne'),
            (Tokens.SPACING, ' '), (Tokens.IMMEDIATE, '0x002'),
            (Tokens.NEWLINE, '\n'),
        ],
        'x86_base': ['lock repne jne 2'],
        'x86_innereye': ['lock repne jne {immval}'],
    ...
    {  # Jump with branch prediction (taken)
        ...
        'x86_base_tokenizer': [
            (Tokens.INSTRUCTION_PREFIX, 'lock'), (Tokens.SPACING, ' '), (Tokens.INSTRUCTION_PREFIX, 'repne'),
                (Tokens.SPACING, ' '), (Tokens.BRANCH_PREDICTION, 'pt'), (Tokens.SPACING, ' '), (Tokens.OPCODE, 'jne'),
            (Tokens.SPACING, ' '), (Tokens.IMMEDIATE, '0x002'),
            (Tokens.NEWLINE, '\n'),
        ],
        'x86_base': ['lock repne jne 2'],
    ...
    {  # Token mismatch (unknown branch prediction)
        'input': 'lock jne.repne,pd 0x31341',
        'bad_assembly': True, 
        'x86_base_tokenizer': ValueError,
        'x86_base': ValueError,
        'x86_innereye': ValueError,
        'x86_deepbindiff': ValueError,
        'x86_safe': ValueError,
        'x86_deepsemantic': ValueError,
        'x86_hpc': ValueError,
        'x86_hpc_repl': ValueError,
    },
