...
def get_manual_cfg(build_level):
    ...
    __auto_functions = {
        4096: func_type(parent_cfg=__auto_cfg, address=4096, name='_init', is_extern_func=False),
        4160: func_type(parent_cfg=__auto_cfg, address=4160, name=None, is_extern_func=False),
        4176: func_type(parent_cfg=__auto_cfg, address=4176, name='printf@plt', is_extern_func=True),
        4192: func_type(parent_cfg=__auto_cfg, address=4192, name='_start', is_extern_func=False),
        4240: func_type(parent_cfg=__auto_cfg, address=4240, name='deregister_tm_clones', is_extern_func=False),
        4288: func_type(parent_cfg=__auto_cfg, address=4288, name='register_tm_clones', is_extern_func=False),
        4352: func_type(parent_cfg=__auto_cfg, address=4352, name='__do_global_dtors_aux', is_extern_func=False),
        4416: func_type(parent_cfg=__auto_cfg, address=4416, name='frame_dummy', is_extern_func=False),
        4425: func_type(parent_cfg=__auto_cfg, address=4425, name='search_char', is_extern_func=False),
        4514: func_type(parent_cfg=__auto_cfg, address=4514, name='mutate', is_extern_func=False),
        4655: func_type(parent_cfg=__auto_cfg, address=4655, name='main', is_extern_func=False),
        4816: func_type(parent_cfg=__auto_cfg, address=4816, name='__libc_csu_init', is_extern_func=False),
        4928: func_type(parent_cfg=__auto_cfg, address=4928, name='__libc_csu_fini', is_extern_func=False),
        4936: func_type(parent_cfg=__auto_cfg, address=4936, name='_fini', is_extern_func=False),
    }

    # Building basic blocks. Dictionary maps integer address to CFGBasicBlock() object
    __auto_blocks = {
        4096: CFGBasicBlock(parent_function=__auto_functions[4096], address=4096, metadata={},
            asm_memory_addresses=[4096, 4100, 4104, 4111, 4114],
            asm_lines=[
                'nop',
                'sub    rsp, 0x08',
        ...
        4116: CFGBasicBlock(parent_function=__auto_functions[4096], address=4116, metadata={},
            asm_memory_addresses=[4116],
            asm_lines=[
                'call   rax',
            ]
        ),
        4118: CFGBasicBlock(parent_function=__auto_functions[4096], address=4118, metadata={},
            asm_memory_addresses=[4118, 4122],
            asm_lines=[
                'add    rsp, 0x08',
                'ret',
            ]
        ),
        4160: CFGBasicBlock(parent_function=__auto_functions[4160], address=4160, metadata={},
            asm_memory_addresses=[4160, 4164],
            asm_lines=[
                'nop',
                'jmp    qword ds:[rip + 0x0000000000002fad<12205,absolute=0x0000000000003ff8>]',
            ]
        ),
        4176: CFGBasicBlock(parent_function=__auto_functions[4176], address=4176, metadata={},
            asm_memory_addresses=[4176, 4180],
            asm_lines=[
                'nop',
                'jmp    qword ds:[rip + 0x0000000000002f75<12149,absolute=0x0000000000003fd0>]',
            ]
        ),
        4192: CFGBasicBlock(parent_function=__auto_functions[4192], address=4192, metadata={},
            asm_memory_addresses=[4192, 4196, 4198, 4201, 4202, 4205, 4209, 4210, 4211, 4218, 4225, 4232],
            asm_lines=[
                'nop',
                'xor    ebp, ebp',
                'mov    r9, rdx',
        ...
        4238: CFGBasicBlock(parent_function=__auto_functions[4192], address=4238, metadata={},
            asm_memory_addresses=[4238],
            asm_lines=[
                'hlt',
            ]
        ),
        4240: CFGBasicBlock(parent_function=__auto_functions[4240], address=4240, metadata={},
            asm_memory_addresses=[4240, 4247, 4254, 4257],
            asm_lines=[
        ...
        4259: CFGBasicBlock(parent_function=__auto_functions[4240], address=4259, metadata={},
            asm_memory_addresses=[4259, 4266, 4269],
            asm_lines=[
        ...
        4271: CFGBasicBlock(parent_function=__auto_functions[4240], address=4271, metadata={},
            asm_memory_addresses=[4271],
            asm_lines=[
                'jmp    rax',
            ]
        ),
        4280: CFGBasicBlock(parent_function=__auto_functions[4240], address=4280, metadata={},
            asm_memory_addresses=[4280],
            asm_lines=[
                'ret',
            ]
        ),
        4288: CFGBasicBlock(parent_function=__auto_functions[4288], address=4288, metadata={},
            asm_memory_addresses=[4288, 4295, 4302, 4305, 4308, 4312, 4316, 4319, 4322],
            asm_lines=[
        ...
        4324: CFGBasicBlock(parent_function=__auto_functions[4288], address=4324, metadata={},
            asm_memory_addresses=[4324, 4331, 4334],
            asm_lines=[
        ...
        4336: CFGBasicBlock(parent_function=__auto_functions[4288], address=4336, metadata={},
            asm_memory_addresses=[4336],
            asm_lines=[
                'jmp    rax',
            ]
        ),
        4344: CFGBasicBlock(parent_function=__auto_functions[4288], address=4344, metadata={},
            asm_memory_addresses=[4344],
            asm_lines=[
                'ret',
            ]
        ),
        4352: CFGBasicBlock(parent_function=__auto_functions[4352], address=4352, metadata={},
            asm_memory_addresses=[4352, 4356, 4363],
            asm_lines=[
                'nop',
        ...
        4365: CFGBasicBlock(parent_function=__auto_functions[4352], address=4365, metadata={},
            asm_memory_addresses=[4365, 4366, 4374, 4377],
            asm_lines=[
                'push   rbp',
        ...
        4379: CFGBasicBlock(parent_function=__auto_functions[4352], address=4379, metadata={},
            asm_memory_addresses=[4379, 4386],
            asm_lines=[
                'mov    rdi, qword ds:[rip + 0x0000000000002ee6<12006,absolute=0x0000000000004008>]',
                'call   0x0000000000001040<4160>',
            ]
        ),
        4391: CFGBasicBlock(parent_function=__auto_functions[4352], address=4391, metadata={},
            asm_memory_addresses=[4391],
            asm_lines=[
                'call   0x0000000000001090<4240,(func)deregister_tm_clones>',
            ]
        ),
        4396: CFGBasicBlock(parent_function=__auto_functions[4352], address=4396, metadata={},
            asm_memory_addresses=[4396, 4403, 4404],
            asm_lines=[
        ...
        4408: CFGBasicBlock(parent_function=__auto_functions[4352], address=4408, metadata={},
            asm_memory_addresses=[4408],
            asm_lines=[
                'ret',
            ]
        ),
        4416: CFGBasicBlock(parent_function=__auto_functions[4416], address=4416, metadata={},
            asm_memory_addresses=[4416, 4420],
            asm_lines=[
                'nop',
                'jmp    0x00000000000010c0<4288,(func)register_tm_clones>',
            ]
        ),
        4425: CFGBasicBlock(parent_function=__auto_functions[4425], address=4425, metadata={},
            asm_memory_addresses=[4425, 4429, 4430, 4433, 4437, 4439, 4442, 4446, 4450],
            asm_lines=[
                'nop',
                'push   rbp',
                'mov    rbp, rsp',
        ...
        4452: CFGBasicBlock(parent_function=__auto_functions[4425], address=4452, metadata={},
            asm_memory_addresses=[4452],
            asm_lines=[
                'add    qword ds:[rbp + 0xe8<-24>], 0x01',
            ]
        ),
        4457: CFGBasicBlock(parent_function=__auto_functions[4425], address=4457, metadata={},
            asm_memory_addresses=[4457, 4461, 4464, 4466],
            asm_lines=[
                'mov    rax, qword ds:[rbp + 0xe8<-24>]',
        ...
        4468: CFGBasicBlock(parent_function=__auto_functions[4425], address=4468, metadata={},
            asm_memory_addresses=[4468, 4472, 4475, 4478],
            asm_lines=[
                'mov    rax, qword ds:[rbp + 0xe8<-24>]',
                'movzx  eax, byte ds:[rax]',
        ...
        4480: CFGBasicBlock(parent_function=__auto_functions[4425], address=4480, metadata={},
            asm_memory_addresses=[4480, 4484, 4487, 4489],
            asm_lines=[
                'mov    rax, qword ds:[rbp + 0xe8<-24>]',
                'movzx  eax, byte ds:[rax]',
                'test   al, al',
        ...
        4491: CFGBasicBlock(parent_function=__auto_functions[4425], address=4491, metadata={},
            asm_memory_addresses=[4491, 4495],
            asm_lines=[
                'cmp    byte ds:[rbp + 0xe4<-28>], 0x00<(func)__cxa_finalize@@GLIBC_2.2.5>',
                'jne    0x000000000000119b<4507>',
            ]
        ),
        4497: CFGBasicBlock(parent_function=__auto_functions[4425], address=4497, metadata={},
            asm_memory_addresses=[4497, 4501, 4505],
            asm_lines=[
                'mov    rax, qword ds:[rbp + 0xe8<-24>]',
        ...
        4507: CFGBasicBlock(parent_function=__auto_functions[4425], address=4507, metadata={},
            asm_memory_addresses=[4507],
            asm_lines=[
                'mov    eax, 0xffffffff<-1>',
            ]
        ),
        4512: CFGBasicBlock(parent_function=__auto_functions[4425], address=4512, metadata={},
            asm_memory_addresses=[4512, 4513],
            asm_lines=[
                'pop    rbp',
                'ret',
            ]
        ),
        4514: CFGBasicBlock(parent_function=__auto_functions[4514], address=4514, metadata={},
            asm_memory_addresses=[4514, 4518, 4519, 4522, 4526, 4530, 4533, 4537, 4541, 4545, 4550, 4553],
            asm_lines=[
                'nop',
                'push   rbp',
                'mov    rbp, rsp',
        ...
        4558: CFGBasicBlock(parent_function=__auto_functions[4514], address=4558, metadata={},
            asm_memory_addresses=[4558, 4561, 4565],
            asm_lines=[
        ...
        4567: CFGBasicBlock(parent_function=__auto_functions[4514], address=4567, metadata={},
            asm_memory_addresses=[4567, 4572],
            asm_lines=[
                'mov    eax, 0x00000001',
                'jmp    0x000000000000122d<4653>',
            ]
        ),
        4574: CFGBasicBlock(parent_function=__auto_functions[4514], address=4574, metadata={},
            asm_memory_addresses=[4574, 4578, 4581, 4584, 4587, 4588, 4590, 4592, 4593, 4596, 4598, 4601, 4605, 4608, 4612, 4616, 4619, 4623, 4625],
            asm_lines=[
                'mov    rax, qword ds:[rbp + 0xd8<-40>]',
                'movzx  eax, byte ds:[rax]',
                'movsx  ecx, al',
        ...
        4630: CFGBasicBlock(parent_function=__auto_functions[4514], address=4630, metadata={},
            asm_memory_addresses=[4630, 4635],
            asm_lines=[
                'cmp    qword ds:[rbp + 0xf0<-16>], 0x00<(func)__cxa_finalize@@GLIBC_2.2.5>',
                'je     0x0000000000001228<4648>',
            ]
        ),
        4637: CFGBasicBlock(parent_function=__auto_functions[4514], address=4637, metadata={},
            asm_memory_addresses=[4637, 4641, 4644, 4646],
            asm_lines=[
                'mov    rax, qword ds:[rbp + 0xd8<-40>]',
                'movzx  eax, byte ds:[rax]',
                'test   al, al',
        ...
        4648: CFGBasicBlock(parent_function=__auto_functions[4514], address=4648, metadata={},
            asm_memory_addresses=[4648],
            asm_lines=[
                'mov    eax, 0x00000000<(func)__cxa_finalize@@GLIBC_2.2.5>',
            ]
        ),
        4653: CFGBasicBlock(parent_function=__auto_functions[4514], address=4653, metadata={},
            asm_memory_addresses=[4653, 4654],
            asm_lines=[
                'leave',
                'ret',
            ]
        ),
        4655: CFGBasicBlock(parent_function=__auto_functions[4655], address=4655, metadata={},
            asm_memory_addresses=[4655, 4659, 4660, 4663, 4667, 4670, 4674, 4678, 4682, 4686, 4690, 4695, 4698],
            asm_lines=[
                'nop',
                'push   rbp',
                'mov    rbp, rsp',
        ...
        4703: CFGBasicBlock(parent_function=__auto_functions[4655], address=4703, metadata={},
            asm_memory_addresses=[4703, 4706, 4709, 4711, 4718, 4723],
            asm_lines=[
        ...
        4728: CFGBasicBlock(parent_function=__auto_functions[4655], address=4728, metadata={},
            asm_memory_addresses=[4728, 4732, 4735, 4742, 4747],
            asm_lines=[
                'mov    rax, qword ds:[rbp + 0xf8<-8>]',
                'mov    rsi, rax',
        ...
        4752: CFGBasicBlock(parent_function=__auto_functions[4655], address=4752, metadata={},
            asm_memory_addresses=[4752, 4756, 4761, 4764],
            asm_lines=[
                'mov    rax, qword ds:[rbp + 0xf8<-8>]',
        ...
        4769: CFGBasicBlock(parent_function=__auto_functions[4655], address=4769, metadata={},
            asm_memory_addresses=[4769, 4772, 4776, 4779, 4786, 4791],
            asm_lines=[
        ...
        4796: CFGBasicBlock(parent_function=__auto_functions[4655], address=4796, metadata={},
            asm_memory_addresses=[4796, 4801, 4802],
            asm_lines=[
                'mov    eax, 0x00000000<(func)__cxa_finalize@@GLIBC_2.2.5>',
                'leave',
                'ret',
        ...
        4816: CFGBasicBlock(parent_function=__auto_functions[4816], address=4816, metadata={},
            asm_memory_addresses=[4816, 4820, 4822, 4829, 4831, 4834, 4836, 4839, 4841, 4844, 4845, 4852, 4853, 4856, 4860],
            asm_lines=[
                'nop',
                'push   r15',
        ...
        4865: CFGBasicBlock(parent_function=__auto_functions[4816], address=4865, metadata={},
            asm_memory_addresses=[4865, 4869],
            asm_lines=[
                'sar    rbp, 0x03',
                'je     0x0000000000001326<4902>',
            ]
        ),
        4871: CFGBasicBlock(parent_function=__auto_functions[4816], address=4871, metadata={},
            asm_memory_addresses=[4871, 4873],
            asm_lines=[
                'xor    ebx, ebx',
                'nop    dword ds:[rax + 0x00000000<(func)__cxa_finalize@@GLIBC_2.2.5>]',
            ]
        ),
        4880: CFGBasicBlock(parent_function=__auto_functions[4816], address=4880, metadata={},
            asm_memory_addresses=[4880, 4883, 4886, 4889],
            asm_lines=[
                'mov    rdx, r14',
                'mov    rsi, r13',
                'mov    edi, r12d',
        ...
        4893: CFGBasicBlock(parent_function=__auto_functions[4816], address=4893, metadata={},
            asm_memory_addresses=[4893, 4897, 4900],
            asm_lines=[
                'add    rbx, 0x01',
                'cmp    rbp, rbx',
        ...
        4902: CFGBasicBlock(parent_function=__auto_functions[4816], address=4902, metadata={},
            asm_memory_addresses=[4902, 4906, 4907, 4908, 4910, 4912, 4914, 4916],
            asm_lines=[
                'add    rsp, 0x08',
                'pop    rbx',
                'pop    rbp',
        ...
        4928: CFGBasicBlock(parent_function=__auto_functions[4928], address=4928, metadata={},
            asm_memory_addresses=[4928, 4932],
            asm_lines=[
                'nop',
                'ret',
            ]
        ),
        4936: CFGBasicBlock(parent_function=__auto_functions[4936], address=4936, metadata={},
            asm_memory_addresses=[4936, 4940, 4944, 4948],
            asm_lines=[
                'nop',
                'sub    rsp, 0x08',
                'add    rsp, 0x08',
    ...
    expected = {
        ...
        'sorted_block_order': [4096, 4116, 4118, 4160, 4176, 4192, 4238, 4240, 4259, 4271, 4280, 4288, 4324, 4336, 4344, 4352, 4365, 4379, 4391, 4396, 4408, 4416, 4425, 4452, 4457, 4468, 4480, 4491, 4497, 4507, 4512, 4514, 4558, 4567, 4574, 4630, 4637, 4648, 4653, 4655, 4703, 4728, 4752, 4769, 4796, 4816, 4865, 4871, 4880, 4893, 4902, 4928, 4936],
        'num_blocks': {4096: 3, 4160: 1, 4176: 1, 4192: 2, 4240: 4, 4288: 4, 4352: 6, 4416: 1, 4425: 9, 4514: 8, 4655: 6, 4816: 6, 4928: 1, 4936: 1},
        'num_asm_lines_per_block': {4096: 5, 4116: 1, 4118: 2, 4160: 2, 4176: 2, 4192: 12, 4238: 1, 4240: 4, 4259: 3, 4271: 1, 4280: 1, 4288: 9, 4324: 3, 4336: 1, 4344: 1, 4352: 3, 4365: 4, 4379: 2, 4391: 1, 4396: 3, 4408: 1, 4416: 2, 4425: 9, 4452: 1, 4457: 4, 4468: 4, 4480: 4, 4491: 2, 4497: 3, 4507: 1, 4512: 2, 4514: 12, 4558: 3, 4567: 2, 4574: 19, 4630: 2, 4637: 4, 4648: 1, 4653: 2, 4655: 13, 4703: 6, 4728: 5, 4752: 4, 4769: 6, 4796: 3, 4816: 15, 4865: 2, 4871: 2, 4880: 4, 4893: 3, 4902: 8, 4928: 2, 4936: 4},
        'num_asm_lines_per_function': {4096: 8, 4160: 2, 4176: 2, 4192: 13, 4240: 9, 4288: 14, 4352: 14, 4416: 2, 4425: 30, 4514: 45, 4655: 37, 4816: 34, 4928: 2, 4936: 4},
        'num_functions': 14,
        'architecture': 'x86',
